...
namespace MainDemo.Web {
    public class Global : System.Web.HttpApplication {
        ...
        private void Instance_CreateCustomObjectSpaceProvider(object sender, CreateCustomObjectSpaceProviderEventArgs e) {
            e.ObjectSpaceProviders.Add(new SecuredObjectSpaceProvider((ISelectDataSecurityProvider)WebApplication.Instance.Security, e.ConnectionString, e.Connection) as IObjectSpaceProvider);
			e.ObjectSpaceProviders.Add(new NonPersistentObjectSpaceProvider(WebApplication.Instance.TypesInfo, null));
		}
