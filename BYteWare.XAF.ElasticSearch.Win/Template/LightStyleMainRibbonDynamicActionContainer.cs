...
namespace BYteWare.XAF.ElasticSearch.Win.Template
{
    ...
    public partial class LightStyleMainRibbonDynamicActionContainer : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IDockManagerHolder, IBarManagerHolder, ISupportViewChanged, IXafDocumentsHostWindow, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder, IDynamicContainersTemplate
    {
        ...
        {
            var uiType = ((IXafDocumentsHostWindow)this).UIType;
        ...
        public LightStyleMainRibbonDynamicActionContainer()
        {
            InitializeComponent();
            InitializeImages();
        ...
        IEnumerable<IActionControl> IActionControlsSite.ActionControls
        {
            get
            {
                var actionControls = new List<IActionControl>(ribbonControl.ActionControls);
