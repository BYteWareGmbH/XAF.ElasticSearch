...
{
    [CLSCompliant(false)]
    public partial class LightStyleMainFormDynamicActionContainer : XtraForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IDockManagerHolder, IBarManagerHolder, ISupportViewChanged, IXafDocumentsHostWindow, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder, IDynamicContainersTemplate
    {
        ...
        public LightStyleMainFormDynamicActionContainer()
        {
            InitializeComponent();
        ...
        IEnumerable<IActionControl> IActionControlsSite.ActionControls
        {
            get
            {
                List<IActionControl> actionControls = new List<IActionControl>(barManager.ActionControls);
